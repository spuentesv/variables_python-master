...
texto_1 = input('Ingrese Nombre completo   : \n')
texto_2 = input('Ingrese DNI               : \n')
texto_3 = input('Ingrese Edad              : \n')
texto_4 = input('Ingrese Altura (ej. 1.80) : \n')

# Imprime datos ingresados

print('Nombre Completo: ', texto_1, ', DNI: ', texto_2)
print('Nombre Completo: ', texto_1, ', Edad: ', texto_3, ', Altura: ', texto_4)
